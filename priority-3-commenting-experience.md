...
**User Story: View Comments on Posts** As a mobile app user, I want to view comments on posts so I can follow community discussions.
...
**User Story: View Media in Comments** As a mobile app user, I want to view media attachments in comments so I can fully engage with visual content shared in discussions.
...
**User Story: Add Comments to Posts** As a mobile app user, I want to add comments to posts so I can participate in conversations.
...
**User Story: Add Media to Comments** As a mobile app user, I want to attach media to my comments so I can share visual content in discussions and better express my ideas.
...
**User Story: Reply to Comments** As a mobile app user, I want to reply to specific comments so I can engage in threaded conversations and respond directly to other users.
...
**User Story: Edit Comments/replies** As a mobile app user, I want to edit my comments/replies after posting them so I can correct mistakes or add additional information.
